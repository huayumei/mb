var Alert = function(msg){
	...
	mask.css({'position':'fixed','width':'100%','height':'100%','top':'0px','left':'0px','background':'rgba(0,0,0,.5)','z-index':'100'});
	box.css({'position':'fixed','width':'200px','top':'50%','left':'50%','background':'#fff','margin-left':'-100px','z-index':'101','margin-top':'-50px','border-radius':'4px'});
	box.append($(
